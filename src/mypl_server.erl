...
init_movement(Mui, DestinationName) ->
    gen_server:call(?SERVER, {init_movement, Mui, DestinationName}).
...
handle_call({init_movement, Mui, DestinationName}, _From, State) ->
    Ret = mypl_db:init_movement(Mui, DestinationName),
    {reply, Ret, State};
