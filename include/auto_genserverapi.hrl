...
feed_eap(Product,Prod_ve1,Prod_exportpackage,Export_pallet,Prod_x,Prod_y,Prod_z,Prod_g,Ve1_x,Ve1_y,Ve1_z,Ve1_g,Export_x,Export_y,Export_z,Export_g) ->
    gen_server:call(?SERVER, {feed_eap, {Product,Prod_ve1,Prod_exportpackage,Export_pallet,Prod_x,Prod_y,Prod_z,Prod_g,Ve1_x,Ve1_y,Ve1_z,Ve1_g,Export_x,Export_y,Export_z,Export_g}}, 39999).
...
handle_call({get_abcclass, {Product}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_abcserver:get_abcclass(Product)) end),
    {noreply, State, 39999};
...
handle_call({statistics, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_statistics:statistics()) end),
    {noreply, State, 39999};

handle_call({bewegungen, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_statistics:bewegungen()) end),
    {noreply, State, 39999};

handle_call({provpipeline_info, {CId}}, _From, State) ->
    Ret = mypl_prov_query:provpipeline_info(CId),
    {reply, Ret, State};

handle_call({provpipeline_list_new, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_prov_query:provpipeline_list_new()) end),
    {noreply, State, 39999};

handle_call({provpipeline_list_processing, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_prov_query:provpipeline_list_processing()) end),
    {noreply, State, 39999};

handle_call({provpipeline_list_prepared, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_prov_query:provpipeline_list_prepared()) end),
    {noreply, State, 39999};

handle_call({provisioninglist_list, {}}, From, State) ->
    proc_lib:spawn(fun() -> gen_server:reply(From, mypl_prov_query:provisioninglist_list()) end),
    {noreply, State, 39999};

handle_call({provisioninglist_info, {CId}}, _From, State) ->
    Ret = mypl_prov_query:provisioninglist_info(CId),
    {reply, Ret, State};

handle_call({find_empty_location_nice, {Height}}, _From, State) ->
    Ret = mypl_db_util:find_empty_location_nice(Height),
    {reply, Ret, State};
...
handle_call({delete_kommiauftrag, {CId}}, _From, State) ->
    Ret = mypl_prov_special:delete_kommiauftrag(CId),
    {reply, Ret, State};

handle_call({update_pipeline, {JsonList}}, _From, State) ->
    Ret = mypl_prov_special:update_pipeline(JsonList),
    {reply, Ret, State};
