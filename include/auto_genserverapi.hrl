...
handle_call({commit_picklist, {}}, _From, State) ->
    Ret = mypl_provpipeline:commit_picklist(),
    {reply, Ret, State};

handle_call({commit_retrievallist, {}}, _From, State) ->
    Ret = mypl_provpipeline:commit_retrievallist(),
    {reply, Ret, State};
