...
init_provisionings_multi(JsonList) ->
    gen_server:call(?SERVER, {init_provisionings_multi, {JsonList}}, 39999).
...
handle_call({push_kommiauftrag, {CId}}, _From, State) ->
    Ret = mypl_prov_special:push_kommiauftrag(CId),
    {reply, Ret, State};
