...
% -export([init_location/5,location_info/1,location_list/0,store_at_location/5,retrive/1,init_movement/2,init_movement_to_good_location/1,commit_movement/1,rollback_movement/1,init_pick/2,commit_pick/1,rollback_pick/1,count_product/1,count_products/0,find_provisioning_candidates/2,find_provisioning_candidates_multi/1,init_provisionings_multi/1]).
