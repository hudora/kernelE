...
update_pipeline(JsonList) ->
    gen_server:call(?SERVER, {update_pipeline, {JsonList}}, 19999).
...
get_abcclass(Product) ->
    gen_server:call(?SERVER, {get_abcclass, {Product}}, 19999).
...
statistics() ->
    gen_server:call(?SERVER, {statistics, {}}, 19999).
...
handle_call({statistics, {}}, _From, State) ->
    Ret = mypl_statistics:statistics(),
    {reply, Ret, State}.
