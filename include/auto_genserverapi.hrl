...
delete_pipeline(CId) ->
    gen_server:call(?SERVER, {delete_pipeline, {CId}}, 39999).
...
% implementation for API and backend for push_picklist
push_picklist(CId) ->
    gen_server:call(?SERVER, {push_picklist, {CId}}, 39999).
...
handle_call({delete_pipeline, {CId}}, _From, State) ->
    Ret = mypl_prov_special:delete_pipeline(CId),
    {reply, Ret, State};
...
handle_call({push_picklist, {CId}}, _From, State) ->
    Ret = mypl_prov_special:push_picklist(CId),
    {reply, Ret, State};
